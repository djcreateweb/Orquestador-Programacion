...
<main class="main-content vincular-page" id="main">
    ...
    <section class="search-section">
        <div class="container">
            ...
            <?php if($vinculada): ?>
                <div class="empty-state vincular-linked">
                    ...
                    <p class="empty-desc vincular-riot">
                        <span class="vincular-riotid"><?php echo htmlspecialchars($riot_id_actual); ?><span class="vincular-hash">#</span><?php echo htmlspecialchars($riot_tag_actual); ?></span>
                    ...
                    <div class="vincular-actions">
                        <form action="index.php?controlador=usuario&amp;action=vincular" method="post">
                            <?php echo csrf_field(); ?>
            ...
            <?php else: ?>
                <form class="search-form" action="index.php?controlador=usuario&amp;action=vincular" method="post">
                    <?php echo csrf_field(); ?>
                    ...
                    <p class="section-subtitle spaced-top-lg vincular-trust">
                        No te pedimos tu contraseña en ningún momento. Solo usamos tu Riot ID público, como cualquier tracker.
                    </p>
                </form>
            <?php endif; ?>
