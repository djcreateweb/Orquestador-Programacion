    ...
    <section class="search-section">
        <div class="container">
            <div class="empty-state">
                ...
                <h3 class="empty-title">Alta manual en desarrollo</h3>
                <p class="empty-desc">
                    El alta de usuarios desde el panel admin aún no está disponible.
                    Mientras tanto, los nuevos usuarios pueden registrarse desde la pestaña
                    <strong>Registrarse</strong> en la pantalla de acceso.
                </p>
                <div class="spaced-actions">
                    <a href="index.php?controlador=usuario&amp;action=registro" class="btn-ghost btn-small">Abrir formulario de registro</a>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="results-bar">
                <h2 class="section-title results-title">
                    Listado de usuarios
                    <span class="badge badge--muted"><?php echo isset($array) ? count($array) : 0; ?></span>
                </h2>
            </div>
                        ...
                        <tbody>
                            <?php foreach($array as $registro): ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php if((int)($registro['id'] ?? 0) === (int)($_SESSION['usuario']['id'] ?? 0)): ?>
                                        ...
                                        <?php else: ?>
                                            <form class="inline-form" action="index.php?controlador=usuario&amp;action=gestionar" method="post"
                                                  data-confirm="¿Borrar este usuario?">
                                                <?php echo csrf_field(); ?>
